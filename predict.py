...
def trainval(checkUploadCanceled, onProgressUpload, item_id, original_video_path, predicted_video_path, model_dir="DeepFish/croatia_result2/c21f602e9488d5dda34d493d345d128a"):
    """
    ...
    if os.path.exists(model_path):
        ...
        model.predict_video(checkUploadCanceled, onProgressUpload, item_id, original_video_path, predicted_video_path)
    print("FINISH!!!!!")
